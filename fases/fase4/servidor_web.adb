...
BEGIN
        ...
        LOOP
				...
				res_aux:=STAT(ASU.to_string(directorio), estructura_stat);
				...
				desc_fich:= OPEN(ASU.to_string(directorio),O_RDONLY); --abrimos en modo lectura
					...
					IF desc_fich=-1 THEN --error en open:no acceso x no existencia del archivo
                	...
                	ELSE
                        ...
                        IF nBytesLect=-1 THEN --si dio -1... 
                                        ...
                                        ELSE --o si no, hubo error de lectura
                                                TXT.PUT_LINE("Error al intentar leer, y no pq sea un directorio");
                                        END IF; 
